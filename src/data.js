export const ways = [
  ...
  },
  {
    ...
    description: 'Вашему прогрессу в обучении способствуют наставники, отдел заботы и техподдержка Result.',
  },
  {
    title: 'Система контроля качества.',
    description: 'Мы проверяем и постоянно совершенствуем учебную программу с учетом изменений технологий на рынке и обратной связи.'
  }
